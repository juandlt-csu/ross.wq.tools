...
load_calibration_data(
  ...
  update = FALSE,
  field_cal_dir = here::here("..", "poudre_sonde_network", "data", "calibration_reports"),
  benchtop_cal_dir = here::here("..", "poudre_sonde_network", "data", "calibration_reports", "benchtop_calibrations")
)
